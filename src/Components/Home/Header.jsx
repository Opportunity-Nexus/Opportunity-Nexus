        ...
        <>
          <div className="relative flex justify-between items-center px-4 py-2  sm:px-6 lg:justify-start lg:space-x-10 max-w-7xl mx-auto">
            ...
            <div className="-mr-2 -my-2 lg:hidden flex items-center">
              <Popover.Button className=" rounded-md p-2 inline-flex items-center justify-center hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary-500"  ref={menuRef}>
