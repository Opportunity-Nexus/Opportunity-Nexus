                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <div className="text-lg leading-6 font-medium space-y-1">
                      <h3 className="text-black dark:text-white">{person.name}</h3>
                      <p className="text-primary-600">{person.role}</p>
                    </div>
                    <ul role="list" className="flex justify-center space-x-5">
                      <li>
                        <a href={person.twitterUrl} target="blank" className="dark:text-gray-400 text-gray-600 hover:text-gray-500">
                      ...
                      <li>
                        <a href={person.linkedinUrl} target="blank" className="dark:text-gray-400 text-gray-600  hover:text-gray-500">
