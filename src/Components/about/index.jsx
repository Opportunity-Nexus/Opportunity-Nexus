const features = [
  {
    ...
    description:
      " Our platform offers a wide range of opportunities, both on-campus and off-campus, in one convenient location. You can explore various options and discover the perfect fit for your career aspirations.",
    icon: () => (
      <svg
  ...
  },
  {
    ...
    description:
      " Build a comprehensive and impressive professional profile effortlessly. List your achievements, work experience, skills, education, and more, all in one place, so employers can see your potential at a glance.",
    icon: () => (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
  ...
  },
  {
    ...
    description:
      " Keep tabs on your applications easily. Our system tracks your application progress and provides updates, ensuring you're always in the know about where you stand in the application process.",
    icon: () => (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
