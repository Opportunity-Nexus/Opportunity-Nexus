          ...
          <div className="sticky top-0 z-10 flex-shrink-0 flex items-center h-16 bg-white  dark:bg-gray-900 shadow dark:shadow-gray-700 min-w-full">
            ...
            <div className="flex-1 px-4 flex items-center justify-between md:pt-5">
              <div className="flex-1 flex">
                <form className="w-full flex md:ml-0" action="#" method="GET">
                  ...
                  <div className="relative w-full text-gray-400 focus-within:text-gray-600">
                    ...
                    <input
                      id="search-field"
                      className="block w-full h-full pl-8 pr-3 py-2 border-transparent bg-transparent text-gray-900 placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-0 focus:border-transparent sm:text-sm"
                      placeholder="Search"
                      type="search"
                      name="search"
                    />
              ...
              <div className="ml-4 flex items-center md:ml-6 gap-3">
                <button
                  type="button"
                  className="bg-white  dark:bg-gray-900 p-1 rounded-full text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"
                >
